      ...
      <div className="header-left">
        <Link to="/" className="header-logo">
          ...
          <svg className="mini-clock" viewBox="0 0 100 100" width="38" height="38" fill="none" stroke="rgba(255,255,255,0.85)" strokeWidth="2">
            ...
            <circle cx="50" cy="50" r="30" strokeDasharray="6 4" strokeWidth="3" stroke="rgba(255,255,255,0.4)" className="gear-fast-reverse" style={{ transformOrigin: '50px 50px', transformBox: 'fill-box' }} />
